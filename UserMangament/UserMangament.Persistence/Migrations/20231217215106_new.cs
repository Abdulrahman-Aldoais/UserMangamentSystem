    ...
    public partial class @new : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Limited = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HolidaysTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentEmployeeCounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DepartmentEmployeeCounts_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Employment_TypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkingHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkingHours_Employment_Types_Employment_TypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProccedByUserId = table.Column<int>(type: "int", nullable: false),
                    HolidaysTypeId = table.Column<int>(type: "int", nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Emp_Holidays_Orders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Emp_Holidays_Orders_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emp_Holidays_Orders_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Emp_Holidays_Orders_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "Emp_Holidays_Stocks",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    HolidayTotal = table.Column<int>(type: "int", nullable: false),
                    HolidayRest = table.Column<int>(type: "int", nullable: false),
                    Years = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Emp_Holidays_Stocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Emp_Holidays_Stocks_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentEmployeeCounts_DepartmentId",
                table: "DepartmentEmployeeCounts",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Emp_Holidays_Orders_DepartmentId",
                table: "Emp_Holidays_Orders",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Emp_Holidays_Orders_EmployeeId",
                table: "Emp_Holidays_Orders",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Emp_Holidays_Orders_UserId",
                table: "Emp_Holidays_Orders",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Emp_Holidays_Stocks_EmployeeId",
                table: "Emp_Holidays_Stocks",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHours_Employment_TypeId",
                table: "WorkingHours",
